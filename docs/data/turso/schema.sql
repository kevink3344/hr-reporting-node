...
-- =====================================================================
-- person_favorites — person-level favorites with report provenance
--   One favorite per person per user globally (first report wins).
--   Denormalized display fields survive report renames/deletes.
-- =====================================================================
